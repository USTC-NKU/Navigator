...
window.addEventListener('load', function () {
    ...
    element.src = "./staryhti/js/music.js";
...
const add_id = "vglzxpi0jkqcrron"; // app_id
const app_secret = "b1FwZ01MZldDUU1lR3ZydUludlJvZz09"; // app_secret
...
$("#github").mouseover(function () {
    $("#link-text").html("这是我的Github");
}).mouseout(function () {
    $("#link-text").html("这些是联系我的方式呢");
});
$("#qq").mouseover(function () {
    $("#link-text").html("有急事可以通过QQ留言涅");
}).mouseout(function () {
    $("#link-text").html("这些是联系我的方式呢");
});
$("#email").mouseover(function () {
    $("#link-text").html("写邮件可以更快联系到我呢");
}).mouseout(function () {
    $("#link-text").html("这些是联系我的方式呢");
});
$("#telegram").mouseover(function () {
    $("#link-text").html("其实我不玩微博啦");
}).mouseout(function () {
    $("#link-text").html("这些是联系我的方式呢");
});
$("#twitter").mouseover(function () {
    $("#link-text").html("我也没有小破站哦");
}).mouseout(function () {
    $("#link-text").html("这些是联系我的方式呢");
});
...
$('#switchmore').on('click', function () {
    ...
    if (shoemore && $(document).width() >= 990) {
        ...
        $("#change").html("Surprise&nbsp;!");
        $("#change1").html("再点一次可以返回欧");
    } else {
        $('#container').attr('class', 'container');
        $("#change").html("Science&nbsp;Lights up&nbsp;the world!");
        $("#change1").html("星海·高科");
    }
});
...
var title1 = '星海·高科'
var title2 = `
________  _________  ________  ________      ___    ___ ___  ___  _________  ___     
|\   ____\|\___   ___\\   __  \|\   __  \    |\  \  /  /|\  \|\  \|\___   ___\\  \    
\ \  \___|\|___ \  \_\ \  \|\  \ \  \|\  \   \ \  \/  / | \  \\\  \|___ \  \_\ \  \   
 \ \_____  \   \ \  \ \ \   __  \ \   _  _\   \ \    / / \ \   __  \   \ \  \ \ \  \  
  \|____|\  \   \ \  \ \ \  \ \  \ \  \\  \|   \/  /  /   \ \  \ \  \   \ \  \ \ \  \ 
    ____\_\  \   \ \__\ \ \__\ \__\ \__\\ _\ __/  / /      \ \__\ \__\   \ \__\ \ \__\
   |\_________\   \|__|  \|__|\|__|\|__|\|__|\___/ /        \|__|\|__|    \|__|  \|__|
   \|_________|                             \|___|/                                                                                
`
var content = `
科学之光，温暖世界，点亮未来
