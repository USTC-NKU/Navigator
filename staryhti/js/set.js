...
//     )
// });
const wallpaper_api_1="https://api.leafone.cn/api/bing"
const wallpaper_api_2="https://api.ixiaowai.cn/gqapi/gqapi.php"
const wallpaper_api_3="https://api.ixiaowai.cn/api/api.php"
...
function setBgImgInit() {
    ...
    switch (bg_img["type"]) {
        ...
        //     break;
        case "1":
            $('#bg').attr('src', wallpaper_api_1); //必应每日
            break;
        case "2":
            $('#bg').attr('src', wallpaper_api_2); //随机风景
            break;
        case "3":
            $('#bg').attr('src', wallpaper_api_3); //随机动漫
            break;
    }
};
